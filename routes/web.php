...
Route::group(['prefix'=>'products'], function(){
    ...
    Route::get('/deletecart/{id}', [App\Http\Controllers\Products\ProductsController::class, 'deleteFromCart'])->name('products.cart.delete');
    ...
    Route::post('/checkout', [App\Http\Controllers\Products\ProductsController::class, 'processCheckout'])->name('products.process.checkout')->middleware('check.for.price');
...
Route::group(['prefix'=>'users'], function(){
    //users Pages
    //middleware('auth:web): default middleware, user cannot access to pages if he is logged out
    Route::get('/my-orders', [App\Http\Controllers\Users\UsersController::class, 'myOrders'])->name('users.myorders')->middleware('auth:web');
