                ...
                <div class="col-xs-12 col-sm-7">
                    ...
                    <form action="{{ route('products.process.checkout') }}" method="POST" class="bill-detail">
                        <fieldset> 
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    <input class="form-control" name="user_id" value="{{ Auth::user()->id }}" placeholder="Email Address" type="text">
                                </div>
                                <div class="col">
                                    <input class="form-control" name="price" value={{ $checkoutsubtotal + 20 }} placeholder="Phone Number" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary" name="submit" style="width: 200px; height:50px">submit</button>
                            </div>
                        </fieldset>
                    </form>
