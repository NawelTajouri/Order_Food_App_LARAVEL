...
<body>
                            ...
                            @else
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="avatar-header"><img src="{{ asset('assets/users_images/userimg.png')}}"></div> {{ Auth::user()->name}}
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route('users.myorders') }}">Transactions History</a>
   ...
   <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                     ...
                     <ul>
                         <li>
                            <a href="tel:+620892738334"><i class="fa fa-phone"></i> +216 50 958 517</a>
                        </li>
                        <li>
                            <a href="mailto:hello@domain.com"><i class="fa fa-envelope"></i> lewan.nawel95@gmail.com</a>
                         </li>
                     </ul>
        ...
        <p class="copyright">&copy; 2023 OrganicLife | Groceries Organic Store. All rights reserved.</p>
    </footer>
